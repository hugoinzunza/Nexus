...
def test_status_is_scheduled_before_preregistered_start():
    status = operational_status([], _config(), now_ms=1786768199999)
...
def test_bot_module_adds_cohort_to_state_without_outcome_metrics():
    ...
    assert data["economic_cohort"]["status"] in {"scheduled", "collecting"}
